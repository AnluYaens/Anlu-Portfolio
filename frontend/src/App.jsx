...
function App() {
  ...
  useEffect(() => {
    ...
    fetch("http://127.0.0.1:8000/projects/")
      ...
      .then((data) => {
        console.log("Data received:", data); // Log data to browser console
  ...
  return (
    <div className="min-h-screen bg-gray-100 p-8">
      ...
      <div className="max-w-4xl mx-auto mb-10 text-center">
        <h1 className="text-4xl font-bold text-blue-700 mb-2">My portfolio</h1>
        <p className="text-gray-600">Full Stack Developer (FastAPI & React)</p>
      </div>
